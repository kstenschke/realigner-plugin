...
This is a plugin for the various intellij IDEs, working in IntelliJ IDEA, RubyMine, WebStorm, PhpStorm, PyCharm, PyCharm CE, AppCode and Android Studio.
...
The retina icon variants have been created newly for this plugin, to resemble the Fugue icons, out of icons from the following iconsets:
* Join and split arrow: Farm Fresh Iconset - http://www.fatcow.com/
* Bookmark, delete: Pixelmixer Basic Set - http://www.pixel-mixer.com/
* Wrap: Iconbeast Lite - http://www.iconbeast.com/
* Book: Momentum Matte Icons - http://momentumdesignlab.com/resources/downloads/
